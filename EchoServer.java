...
public class EchoServer extends AbstractServer {
    ...
    protected void clientException(ConnectionToClient client, Throwable exception) {//send message to the clients when the server is closed
        String message = "<" + client.getInfo("id") + "> has disconnected";
        System.out.println(message);
        this.sendToAllClients(message);

    }
    synchronized protected void clientDisconnected(ConnectionToClient client){//output when the server is closed
